...
3. Dashboard > SQL Editor > New query: pega `schema.sql` completo > Run. Repite con `sync_tombstones.sql` (propaga los borrados entre dispositivos; sin él solo viajan altas y ediciones).
